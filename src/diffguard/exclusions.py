...
def is_generated_file(file_path: str, source_lines: list[str], language: Language) -> bool:  # noqa: PLR0911, PLR0912
    ...
    match language:
        case Language.PYTHON:
            return _is_generated_python(file_path, source_lines)
        ...
        case Language.ELIXIR:
            return _is_generated_elixir(file_path, source_lines)
        case Language.VUE:
...
_PYTHON_GENERATED_MARKERS: tuple[str, ...] = (
    "# Auto-generated",
    "# auto-generated",
    "# Generated by",
    "# DO NOT EDIT",
...
def _is_generated_python(file_path: str, source_lines: list[str]) -> bool:
    """Check if a Python file is auto-generated."""
    # Django migrations with generated header
    if "/migrations/" in file_path and file_path.endswith(".py"):
        for line in source_lines[:10]:
            if "# Generated by Django" in line:
                return True

    # Generic auto-generated header in first 5 lines
    for line in source_lines[:5]:
        stripped = line.strip()
        if any(stripped.startswith(marker) for marker in _PYTHON_GENERATED_MARKERS):
            return True
...
_ELIXIR_GENERATED_MARKERS: tuple[str, ...] = (
    "# Generated by",
    "# DO NOT EDIT",
    "# This file is auto-generated",
    "# Auto-generated",
...
def _is_generated_elixir(_file_path: str, source_lines: list[str]) -> bool:
    """Check if an Elixir file is auto-generated."""
    # Content markers in first 5 lines
    for line in source_lines[:5]:
        stripped = line.strip()
        if any(stripped.startswith(marker) for marker in _ELIXIR_GENERATED_MARKERS):
            return True

    # Avg line length > 500 chars (minified/bundled — unlikely but consistent)
    if source_lines:
        total_chars = sum(len(line) for line in source_lines)
        avg_length = total_chars / len(source_lines)
        if avg_length > 500:
...
def _is_generated_vue(source_lines: list[str]) -> bool:
    """Check if a Vue SFC is minified."""
    if source_lines:
        total_chars = sum(len(line) for line in source_lines)
        avg_length = total_chars / len(source_lines)
        if avg_length > 500:
